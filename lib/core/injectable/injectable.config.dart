...
import 'injectable.dart' as _i25; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i13.CartProductRepository>(
      () => _i14.CartProductrepositoryImpl(
            get<_i11.ProductCartRemoteDataSource>(),
            get<_i9.NetworkInfo>(),
          ));
  gh.lazySingleton<_i15.GetProductInCart>(
      () => _i15.GetProductInCart(get<_i13.CartProductRepository>()));
  gh.lazySingleton<_i16.GetProductsInCartBloc>(
      () => _i16.GetProductsInCartBloc(get<_i15.GetProductInCart>()));
  gh.lazySingleton<_i17.GridMobilePhonesRepository>(
      () => _i18.GridMobilePhonesRepositoryImpl(
            get<_i4.GridMobilePhonesRemoteDataSources>(),
            get<_i9.NetworkInfo>(),
          ));
  gh.lazySingleton<_i19.MobilePhonesDetailsRepository>(
      () => _i20.MobilePhonesDetailsRepositoryImpl(
            get<_i7.MobilePhonesDetailsRemoteDataSource>(),
            get<_i9.NetworkInfo>(),
          ));
  gh.lazySingleton<_i21.GetMobilePhoneDetails>(() =>
      _i21.GetMobilePhoneDetails(get<_i19.MobilePhonesDetailsRepository>()));
  gh.lazySingleton<_i22.GetMobilePhones>(
      () => _i22.GetMobilePhones(get<_i17.GridMobilePhonesRepository>()));
  gh.lazySingleton<_i23.GetProductPhoneDetailsBloc>(
      () => _i23.GetProductPhoneDetailsBloc(get<_i21.GetMobilePhoneDetails>()));
  gh.lazySingleton<_i24.GetSmartphoneGridFirstScreenBloc>(
      () => _i24.GetSmartphoneGridFirstScreenBloc(get<_i22.GetMobilePhones>()));
  return get;
}

class _$RegisterModuleConnectionChecke
    extends _i25.RegisterModuleConnectionChecke {}
